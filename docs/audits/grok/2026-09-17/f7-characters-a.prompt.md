...
# Items to check
src/content/characters/ files: anduin-wrynn, arthas-menethil, cairne-bloodhoof, dark-ranger-anya, garek-bandarion, grom-hellscream, guldan, illidan-stormrage, jaina-proudmoore (.md). Ledger: docs/research/evidence/dossiers.json plus any entry with matching entryRefs.
