...
7. RELATIONS — relatedCharacterIds/relatedFactionIds/relatedLocationIds in the frontmatter that the text and quotes do not justify, and aliases that are not official names.
...
# Items to check
Every file in src/content/locations/*.md (15 entries). Ledger: docs/research/evidence/dossiers.json plus any entry with matching entryRefs.
