...
# Task: fact-check chapters 00–03
Read fully: src/content/chapters/00-azeroth-before-civilization.md, 01-war-of-the-ancients.md, 02-kingdoms-and-peoples.md, 03-orcs-and-humans.md, and the sources they cite (src/content/sources/core.json, open the URLs).
